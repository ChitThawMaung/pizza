                                ...
                                <div class="row">
                                    ...
                                    <div class="row col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="pizzaDescription" type="text"
                                                value="{{ old('pizzaDescription', $pizza->description) }}"class="form-control @error('pizzaDescription') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false" placeholder="Enter Description...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="cc-pament" name="pizzaCategory" type="text"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label mb-1">ViewCount</label>
                                            <input id="cc-pament" name="viewCount" type="text"
                                                value="{{ old('view_count', $pizza->view_count) }}"class="form-control @error('view_count') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="created_at" type="text"
                                                value="{{ $pizza->created_at->format('j-F-Y') }}"class="form-control @error('created_at') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false" disabled>
                                            @error('created_at')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
