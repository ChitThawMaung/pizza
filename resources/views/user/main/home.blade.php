        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div
                            class="d-flex align-items-center justify-content-between mb-3 bg-dark py-1 px-3 text-white mt-2">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                            ...
                            <div class="ml-2">
                                <div class="btn-group">
                                    <select name="sorting" id="sortingOption" class="form-control">
                                        ...
                                        <option value="desc">Desccending...</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <span class="row" id="dataList">
                        ...
                        @endforeach
                    @else
                       <p class="text-center shadow-sm fs-5 col-6 offset-3 py-5">There is no pizza <i class="fa-solid fa-pizza-slice ms-3"></i></p>
                    @endif
                    </span>
...
@section('scriptSource')
    <script>
        ...
        //    $.ajax({
        //        type : 'get' ,
        //        url : 'http://127.0.0.1:8001/user/ajax/pizza/list',
        //        dataType : 'json',
